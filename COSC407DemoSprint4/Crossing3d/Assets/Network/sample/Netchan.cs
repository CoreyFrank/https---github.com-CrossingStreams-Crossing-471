...
public struct Netchan : IFlatbufferObject
{
  ...
  public Player? Players(int j) { int o = __p.__offset(10); return o != 0 ? (Player?)(new Player()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  ...
  public static VectorOffset CreatePlayersVector(FlatBufferBuilder builder, Offset<Player>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
